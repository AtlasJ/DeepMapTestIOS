 ...
 *
 *  @return HDMMapDownloader instance
 *  @note update will fecth only projectName for customerName
 */
 ...
 *  @note Works asynchronously, i.e. doesn't lock main thread
 */
 ...
 *  @note         Base URL for this method is kHDMUpdateBaseUrl.
 */
