...
/**
 Class provides API for fetching infomation about map objects.
 */
...
/**
 ...
 @param path Full path to a Deep Map database
 @param projector Instance of HDMProjector
 @return HDMLocator instance
 */
...
/**
 ...
 @note The SQL query must return feature IDs via a column object_id. After the query executed,
