 ...
 *  @note Before this call no API calls are accepted by the map.
 */
 ...
 *  @note This delegate is mainly used for loading additional resources.
 */
 ...
 *  @note Called each time the user pinchs the map, pans etc.
 */
 ...
 *  @note A map view controller sends messages to its delegate regarding the loading of map data, tapping features or change point of view.
 *
 ...
 *  @note routing is lazy-loading property, i.e. it's not initialized while you don't touch it.
 ...
 *  @note Default map is a map from DeepMap.zip from Main Bundle
 */
 ...
 *  @note Method download the latest map available on the update server and install it
 */
